# Search Engine
## Описание проекта
Эта программа - многопоточный кроссплатформенный локальный консольный поисковый движок по файлам, который позволяет по файлам JSON формировать запросы и выводить результаты поиска.
